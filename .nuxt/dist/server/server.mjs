...
import { $fetch } from "C:/Users/ivanv/.gemini/antigravity-ide/scratch/taurun-quote-produtos/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/ivanv/.gemini/antigravity-ide/scratch/taurun-quote-produtos/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/ivanv/.gemini/antigravity-ide/scratch/taurun-quote-produtos/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/ivanv/.gemini/antigravity-ide/scratch/taurun-quote-produtos/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu } from "C:/Users/ivanv/.gemini/antigravity-ide/scratch/taurun-quote-produtos/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "C:/Users/ivanv/.gemini/antigravity-ide/scratch/taurun-quote-produtos/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DBHll8Ad.js")
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full w-full bg-background text-foreground antialiased selection:bg-primary/20 selection:text-primary" }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BGifCCfh.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BJpydtrK.js"));
