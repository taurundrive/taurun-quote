import { defineComponent, ref, mergeProps, unref, computed, watch, createVNode, resolveDynamicComponent, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderVNode, ssrIncludeBooleanAttr, ssrRenderClass, ssrRenderList } from 'vue/server-renderer';
import { p as publicAssetsURL } from '../routes/renderer.mjs';
import { CheckCircle2, Sun, Moon, FileText, User, Phone, Package, Info, DollarSign, Maximize2, Calculator, Layers, RotateCcw, Hash, Tag, UserCheck, FileCheck, Presentation, ArrowRight, ChevronDown } from 'lucide-vue-next';
...
const PRODUCTS = [
  { id: "revestimento-taurun", name: "Revestimento Taurun", defaultPriceM2: 180, description: "Superf\xEDcie sem divis\xF5es feita em hexafibra de alt\xEDssima resist\xEAncia." },
  { id: "t50-pro", name: "T50-Pro", defaultPriceM2: 220, description: "Tatame profissional unificado com m\xE1xima absor\xE7\xE3o de impacto." },
  { id: "t50-gold", name: "T50-GOLD", defaultPriceM2: 280, description: "Linha premium Taurun para academias de alto padr\xE3o e alta exig\xEAncia." }
];
const SELLERS = [
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div><h2 class="text-base font-bold text-foreground tracking-tight">Dados do Or\xE7amento</h2><p class="text-xs text-muted-foreground">Preencha as informa\xE7\xF5es do cliente e os detalhes do produto.</p></div></div></div><div class="space-y-4"><h3 class="text-xs font-semibold uppercase tracking-wider text-muted-foreground flex items-center gap-2">`);
      _push(ssrRenderComponent(unref(User), { class: "w-3.5 h-3.5" }, null, _parent));
      _push(` 1. Informa\xE7\xF5es do Cliente </h3><div class="grid grid-cols-1 sm:grid-cols-2 gap-4">`);
      ...
      _push(ssrRenderComponent(_sfc_main$5, {
        ...
        icon: unref(Phone),
        hint: "Formata\xE7\xE3o autom\xE1tica de DDD"
      }, null, _parent));
      ...
      _push(ssrRenderComponent(_sfc_main$5, {
        ...
        suffix: "R$/m\xB2",
        hint: "Edit\xE1vel se houver negocia\xE7\xE3o"
      }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$5, {
        id: "quantityM2",
        label: "Quantidade de m\xB2",
        type: "number",
      ...
      _push(ssrRenderComponent(_sfc_main$3, {
        ...
        description: "Ative para adicionar acabamento/prote\xE7\xE3o em vinil click ao or\xE7amento.",
        icon: unref(Layers)
      }, null, _parent));
      if (unref(quote).hasVinilClick.value) {
      ...
      _push(` 4. Vendedor Respons\xE1vel </h3>`);
      _push(ssrRenderComponent(_sfc_main$4, {
        id: "sellerSelect",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h3 class="font-bold text-foreground text-base tracking-tight">Resumo do Or\xE7amento</h3></div></div><div class="bg-secondary/40 rounded-xl p-4 border border-border space-y-1.5"><div class="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider flex items-center gap-1.5">`);
      _push(ssrRenderComponent(unref(User), { class: "w-3.5 h-3.5 text-muted-foreground" }, null, _parent));
      _push(` Cliente </div><p class="text-base font-bold text-foreground truncate">${ssrInterpolate(unref(quote).clientName.value || "Nome do Cliente n\xE3o informado")}</p>`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12"><div class="mb-8 space-y-1.5"><h1 class="text-2xl sm:text-3xl font-extrabold text-foreground tracking-tight"> Calculadora de Or\xE7amento </h1><p class="text-xs sm:text-sm text-muted-foreground max-w-2xl"> Preencha os dados do cliente e configure a metragem do produto para gerar o or\xE7amento em tempo real. </p></div><div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start"><div class="lg:col-span-7">`);
      ...
      if (unref(showModal)) {
        ...
        _push(`</div><div class="space-y-1.5"><h3 class="text-lg font-bold text-foreground">Or\xE7amento Registrado com Sucesso</h3><p class="text-xs text-muted-foreground leading-relaxed"> Os dados de <strong>${ssrInterpolate(unref(quote).clientName.value || "Cliente")}</strong> foram salvos para a apresenta\xE7\xE3o comercial. </p></div><div class="bg-secondary/40 rounded-xl p-3.5 text-left space-y-1.5 text-xs border border-border"><div class="flex justify-between"><span class="text-muted-foreground">Produto:</span><span class="font-bold text-foreground">${ssrInterpolate(unref(quote).selectedProduct.value.name)}</span></div><div class="flex justify-between"><span class="text-muted-foreground">Metragem:</span><span class="font-bold text-foreground">${ssrInterpolate(unref(quote).quantityM2.value)} m\xB2</span></div>`);
        if (unref(quote).hasVinilClick.value) {
...
//# sourceMappingURL=index-DBHll8Ad.mjs.map
