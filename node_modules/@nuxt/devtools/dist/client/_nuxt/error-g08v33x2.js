import{C as e,E as t,W as n,_ as r,dt as i,g as a,h as o,m as s,tn as c,v as l,w as u}from"./vendor/json-editor-vue-k2rpz34q.js";import{D as d,Et as f}from"#entry";import"./composables-dhks1pao.js";import{t as p}from"./stacktrace-list-n2oy2o29.js";var m=/(^|@)\S+:\d+/,h=/^\s*at .*(\S+:\d+|\(native\))/m,g=/^(eval@)?(\[native code\])?$/;function _(e,t){if(e.stacktrace!==void 0||e[`opera#sourceloc`]!==void 0)return w(e,t);if(e.stack&&e.stack.match(h))return b(e,t);if(e.stack)return S(e,t);if(t?.allowEmpty)return[];throw Error(`Cannot parse given Error object`)}function v(e){if(!e.includes(`:`))return[e,void 0,void 0];let t=/(.+?)(?::(\d+))?(?::(\d+))?$/.exec(e.replace(/[()]/g,``));return[t[1],t[2]||void 0,t[3]||void 0]}function y(e,t){return t&&t.slice!=null?Array.isArray(t.slice)?e.slice(t.slice[0],t.slice[1]):e.slice(0,t.slice):e}function b(e,t){return x(e.stack,t)}function x(e,t){return y(e.split(`
