import{C as e,Ct as t,E as n,F as r,Mt as i,P as a,Qt as o,W as s,Y as c,Z as l,_ as u,c as d,ct as f,dt as p,en as m,g as h,h as g,m as _,t as v,tn as y,v as b,w as x}from"./vendor/json-editor-vue-k2rpz34q.js";import{t as S}from"./_plugin-vue_export-helper-e0bby96w.js";import{Bt as C,Ct as w,Et as T,It as E,Jt as D,T as O,_ as k,ct as A,dt as ee,f as j,k as M,nn as N,on as P,pt as te,v as F,wt as I,zt as L}from"#entry";import{t as R}from"./ndrawer-iq9tsfcb.js";import"./composables-dhks1pao.js";import{t as z}from"./nlink-oovljifl.js";import{t as B}from"./help-fab-kzusjvzh.js";import{t as V}from"./nbadge-dq091bml.js";import{t as H}from"./launch-page-k1jy2olz.js";import{t as U}from"./color-nuuzg844.js";import{t as W}from"./stacktrace-list-n2oy2o29.js";import{t as G}from"./duration-display-ce789vbq.js";import{t as K}from"./composable-item-e8kv7080.js";import{t as q}from"./code-diff-el8puwy4.js";var J=Object.assign(n({__name:`TimelineItemFunction`,props:{item:{}},setup(e){let t=e,n=/_op_/,r=_(()=>U(t.item.name,50,60,`_op_`)),i=_(()=>r.value.replace(n,`1`)),a=_(()=>U(t.item.name,50,40)),o=_(()=>r.value.replace(n,`0.2`));return(t,n)=>(s(),b(`button`,{class:`group`,style:m({color:i.value,borderLeft:`2px solid ${i.value}`}),relative:``,"bg-base":``,"text-sm":``,transition:``,"hover:z-1000":``},[g(`div`,{style:m({backgroundColor:o.value}),absolute:``,"bottom-0":``,"left--1px":``,"top-0":``,"w-full":``,"text-sm":``,"transition-all":``,"duration-300":``},null,4),g(`div`,{style:m({color:a.value,"--c":i.value}),border:`r-2 t-2 y-2 transparent`,"min-w-max":``,px1:``,"text-left":``,"group-hover":`border-$c`},y(e.item.name),5)],4))}}),{__name:`TimelineItemFunction`}),Y={relative:``,"h-full":``},X={absolute:``,"left-2":``,"top-2.3em":``,"text-xs":``,op50:``},Z=Object.assign(n({__name:`TimelineSegment`,props:{segment:{}},emits:[`select`],setup(e,{emit:t}){let n=e,r=t,a=P(()=>n.segment.start,{updateInterval:1e3,showSecond:!0,controls:!1,messages:{justNow:``,past:e=>e,future:e=>e,invalid:`-`,second:e=>e?`${e}s`:``,minute:e=>`${e}m`,hour:e=>`${e}h`,week:e=>`${e}w`,day:e=>`${e}d`,month:e=>`${e}mo`,year:e=>`${e}y`}});return(t,n)=>{let o=J;return s(),b(`div`,Y,[g(`button`,{absolute:``,"left-0":``,"right-0":``,"top-0":``,"bg-green:5":``,px2:``,py1:``,"text-left":``,"text-xs":``,"text-green6":``,"font-mono":``,onClick:n[0]||=t=>e.segment.route?r(`select`,e.segment.route):void 0},y(e.segment.route?.event.to),1),g(`div`,X,y(i(a))+` ago `,1),g(`div`,null,[(s(!0),b(d,null,c(e.segment.functions,(e,t)=>(s(),h(o,{key:t,item:e.event,style:m({position:`absolute`,minWidth:`${e.relativeWidth*100}%`,maxWidth:`${e.relativeWidth*100}%`,top:`${4+e.layer*1.6}em`,left:`${e.relativeStart*100}%`}),onClick:t=>r(`select`,e)},null,8,[`item`,`style`,`onClick`]))),128))])])}}}),{__name:`TimelineSegment`}),Q=3e3,ne=50;function re(e){let t=[],n={start:0,end:0,events:[],functions:[],duration:0};for(let r of e){let e=r.end||r.start;(r.start-n.end>Q||r.type===`route`)&&(n={start:r.start,end:e,events:[],functions:[],duration:0},t.push(n)),n.events.push(r),n.end=e+ne}return t.forEach((e,n)=>{let r=e.end-e.start,i=[];e.duration=r,e.previousGap=n>0?e.start-t[n-1].end:0,e.events.forEach(t=>{let n=t.end||t.start,a=0;t.type!==`route`&&(a=i.findIndex(e=>e<=t.start),a===-1?(a=i.length,i.push(n+1e3)):i[a]=n+1e3);let o={event:t,segment:e,relativeStart:(t.start-e.start)/r,relativeWidth:(n-t.start)/r,layer:a};t.type===`function`?e.functions.push(o):e.route=o})}),t}var ie={relative:``},ae={key:0,border:`x base`,"h-full":``,"flex-inline":``,"bg-true-gray-1":``,py15:``,"text-xs":``,"write-vertical-left":``,op50:``,"dark:bg-true-gray-9":``},oe=Object.assign(S(n({__name:`TimelineTable`,props:{data:{}},emits:[`select`],setup(e,{emit:n}){let a=e,l=n,p=t(),h=t(),v=t(),y=t(),S=t(!0),C=t(1.5),T=_(()=>re(a.data.events)),E=_(()=>(a.data.events.length,p.value?.scrollWidth||window.innerWidth));function D(){y.value&&(y.value.style.width=`${E.value}px`)}function O(){S.value&&p.value&&(p.value.scrollTo({left:p.value.scrollWidth-p.value.clientWidth,behavior:`smooth`}),v.value.scrollTo({left:p.value.scrollWidth-p.value.clientWidth,behavior:`smooth`}))}return f(()=>a.data.events.length,async()=>{await r(),D(),O()},{flush:`post`}),N(p,`scroll`,()=>{v.value.scrollLeft!==p.value.scrollLeft&&(D(),v.value.scrollLeft=p.value.scrollLeft,S.value=p.value.scrollLeft>=p.value.scrollWidth-p.value.clientWidth)}),N(v,`scroll`,()=>{v.value.scrollLeft!==p.value.scrollLeft&&(D(),p.value.scrollLeft=v.value.scrollLeft)}),N(p,`wheel`,e=>{e.altKey?(C.value=w(C.value+e.deltaY/200,.5,3),D()):p.value.scrollLeft+=e.deltaY}),(e,t)=>{let n=G,r=Z;return s(),b(d,null,[g(`div`,ie,[g(`div`,{ref_key:`minimap`,ref:h,border:`t b base`,relative:``,"h-50px":``,"ws-nowrap":``,"border-base":``},[(s(!0),b(d,null,c(T.value,(t,n)=>(s(),b(`div`,{key:n,relative:``,"h-full":``,"flex-inline":``,style:m({width:`${Math.max(100,t.duration/10)/E.value*100}%`})},[(s(!0),b(d,null,c(t.functions,(t,n)=>(s(),b(`div`,{key:n,"h-3px":``,rounded:``,style:m({width:`max(${t.relativeWidth*100}%, 10px)`,position:`absolute`,top:`${t.layer*4}px`,left:`${t.relativeStart*100}%`,backgroundColor:(`getHslColorFromStringHash`in e?e.getHslColorFromStringHash:i(U))(t.event.name,50,60)})},null,4))),128)),t.route?(s(),b(`div`,{key:0,absolute:``,"top-0":``,"h-full":``,"w-px":``,"border-l":``,"border-green6":``,op10:``,style:m({left:`${t.route.relativeStart*100}%`})},null,4)):u(``,!0)],4))),128))],512),g(`div`,{ref_key:`minimapScroller`,ref:v,class:`timeline-scroller`,absolute:``,"inset-0":``,"h-full":``,"w-full":``,"of-x-scroll":``},[g(`div`,{ref_key:`minimapScrollerInner`,ref:y,"h-1px":``},null,512)],512)]),g(`div`,{ref_key:`scroller`,ref:p,relative:``,"h-full":``,"w-full":``,"of-x-scroll":``,"of-y-hidden":``,"ws-nowrap":``,"n-panel-grids":``},[(s(!0),b(d,null,c(T.value,(e,i)=>(s(),b(d,{key:i},[e.previousGap&&e.previousGap>=200?(s(),b(`div`,ae,[x(n,{op50:``,duration:e.previousGap,color:!1},null,8,[`duration`])])):u(``,!0),x(r,{"flex-inline":``,"of-x-hidden":``,"bg-base":``,"hover:of-x-visible":``,class:o(i===T.value.length-1?`border-r border-base`:``),segment:e,style:m({width:`${Math.max(50,e.duration/10)*C.value}px`}),onSelect:t[0]||=e=>l(`select`,e)},null,8,[`class`,`segment`,`style`])],64))),128))],512)],64)}}}),[[`__scopeId`,`data-v-da163089`]]),{__name:`TimelineTable`}),se={border:`t base`,flex:`~ col`,"h-full":``,"of-y-auto":``,"text-sm":``},ce=[`onClick`],le={flex:`~`,"ml--1":``,"font-mono":``},ue={key:0,mr2:``,op30:``},de={op75:``},fe={flex:`~ col items-start`},pe={"text-xs":``,"font-mono":``,op30:``},me={"text-green":``,"font-bold":``,"font-mono":``},he=Object.assign(n({__name:`TimelineList`,props:{data:{}},emits:[`select`],setup(e,{emit:t}){let n=t;return(t,r)=>{let a=G;return s(),b(`div`,se,[(s(!0),b(d,null,c(e.data.events,(e,o)=>(s(),b(`button`,{key:o,border:`b base`,px3:``,py2:``,flex:`~ items-center gap-2`,hover:`bg-active`,onClick:t=>n(`select`,e)},[e.type===`function`?(s(),b(d,{key:0},[r[2]||=g(`div`,{"i-carbon-function":``,op50:``},null,-1),g(`div`,{"font-mono":``,style:m({color:e.type===`function`?(`getHslColorFromStringHash`in t?t.getHslColorFromStringHash:i(U))(e.name,50,60):``})},y(e.name),5),g(`div`,le,[r[0]||=g(`div`,{op30:``},` ( `,-1),(s(!0),b(d,null,c(e.args,(e,t)=>(s(),b(d,{key:t},[t?(s(),b(`div`,ue,` , `)):u(``,!0),g(`div`,de,y(e===null?`null`:e===void 0?`undefined`:typeof e==`function`?`[function]`:Array.isArray(e)?`[Array]`:typeof e==`object`?`[object]`:JSON.stringify(e)),1)],64))),128)),r[1]||=g(`div`,{op30:``},` ) `,-1)])],64)):(s(),b(d,{key:1},[r[3]||=g(`div`,{"mr-1":``,"h-7":``,"w-7":``,flex:``,"rounded-lg":``,"bg-primary:5":``,p1:``,"text-green6":``},[g(`div`,{"i-carbon-direction-rotary-right":``,ma:``,"text-lg":``})],-1),g(`div`,fe,[g(`div`,pe,y(e.from),1),g(`div`,me,y(e.to),1)])],64)),r[4]||=g(`div`,{"flex-auto":``},null,-1),e.end?(s(),h(a,{key:2,duration:e.end-e.start,color:e.type===`function`},null,8,[`duration`,`color`])):u(``,!0)],8,ce))),128)),r[5]||=g(`div`,{"min-h-100":``},null,-1)])}}}),{__name:`TimelineList`}),ge={key:0,"text-blue":``},_e={key:1,"text-purple":``},ve={key:2,"text-green":``},ye={key:3,"text-gray":``},be={key:4,"text-gray":``},xe={key:5,"text-gray":``},Se={key:0,"bg-red:10":``,px2:``,py1:``,"text-red":``},Ce={key:1},we={p2:``,"text-sm":``,border:`t base`},Te=Object.assign(n({__name:`TimelineArgumentView`,props:{value:{}},setup(r){let c=r,d=t(),f=t();function m(){try{d.value=JSON.parse(JSON.stringify(c.value))}catch(e){console.error(e),f.value=e}}let _=n({emits:[`setup`],setup(e,{emit:t}){return t(`setup`),()=>null}}),S=I(),C=k();return(t,n)=>{let c=M,w=l(`VMenu`);return typeof r.value==`string`?(s(),b(`div`,ge,y(JSON.stringify(r.value)),1)):typeof r.value==`number`?(s(),b(`div`,_e,y(r.value),1)):typeof r.value==`boolean`?(s(),b(`div`,ve,y(r.value),1)):r.value===void 0?(s(),b(`div`,ye,` undefined `)):typeof r.value==`function`?(s(),b(`div`,be,` [Function`+y(r.value.name?`: ${r.value.name}`:``)+`] `,1)):r.value===null?(s(),b(`div`,xe,` null `)):(s(),h(w,{key:6,placement:`top`},{popper:p(()=>[x(i(_),{onSetup:m}),f.value?(s(),b(`div`,Se,` Failed to display object: `+y(f.value),1)):d.value?(s(),b(`div`,Ce,[x(i(v),a({"model-value":d.value},t.$attrs,{class:[`json-editor-vue`,[i(S)===`dark`?`jse-theme-dark`:``]],"main-menu-bar":!1,"navigation-bar":!1,"status-bar":!1,"read-only":!0,indentation:2,"tab-size":2}),null,16,[`model-value`,`class`]),g(`div`,we,[x(c,{title:`Copy to clipboard`,icon:`carbon-copy`,onClick:n[0]||=e=>i(C)(JSON.stringify(d.value,null,2),`timeline-argument`)},{default:p(()=>[...n[1]||=[e(` Copy `,-1)]]),_:1})])])):u(``,!0)]),default:p(()=>[g(`span`,{"rounded-sm":``,px1:``,"py0.5":``,"text-sm":``,class:o([Array.isArray(r.value)?`text-amber bg-amber:10`:`text-orange bg-orange:10`])},y(Array.isArray(r.value)?`[Array(${r.value.length})]`:`[Object]`),3)]),_:1}))}}}),{__name:`TimelineArgumentView`}),Ee={key:0,"p-4":``,flex:`~ col gap-2`,"text-base":``},De={"mx--1":``},Oe={flex:`~ gap-1`,"font-mono":``},ke={key:1},Ae={key:0,op30:``},je={flex:`~ gap-1`,"text-sm":``},Me={class:`text-sm text-gray-400`},Ne=Object.assign(n({__name:`TimelineDetailsFunction`,props:{record:{}},setup(e){let t=e,n=P(()=>t.record.start,{showSecond:!0}),r=A(),a=_(()=>r.value?.metadata),o=_(()=>r.value?.imports.find(e=>e.as===t.record.name));return(t,r)=>{let l=V,f=K,p=Te,m=G,_=W;return e.record?(s(),b(`div`,Ee,[g(`div`,De,[x(l,{n:`yellow`,textContent:`Function call`})]),g(`div`,Oe,[o.value?(s(),h(f,{key:0,item:o.value,metadata:a.value,counter:!1,classes:`px2 py1`,"mx--2":``},null,8,[`item`,`metadata`])):(s(),b(`span`,ke,y(e.record.name),1)),r[0]||=g(`span`,{ml1:``,op30:``},`(`,-1),(s(!0),b(d,null,c(e.record.args,(e,t)=>(s(),b(d,{key:t},[t?(s(),b(`span`,Ae,`, `)):u(``,!0),x(p,{value:e},null,8,[`value`])],64))),128)),r[1]||=g(`span`,{op30:``},`)`,-1)]),g(`div`,je,[e.record.end?(s(),h(m,{key:0,duration:e.record.end-e.record.start},null,8,[`duration`])):u(``,!0),r[2]||=g(`span`,{mx1:``,op50:``},`·`,-1),g(`div`,Me,y(i(n)),1)]),e.record.stacktrace?(s(),h(_,{key:0,stacktrace:e.record.stacktrace,class:`text-xs text-gray-400`},null,8,[`stacktrace`])):u(``,!0)])):u(``,!0)}}}),{__name:`TimelineDetailsFunction`}),Pe={key:0,"p-4":``,flex:`~ col gap-2`},Fe={"mx--1":``},Ie={flex:`~ gap-1 items-center`,"font-mono":``},Le={op50:``},Re={flex:`~ gap-1`,"text-sm":``},ze={class:`text-sm text-gray-400`},Be=Object.assign(n({__name:`TimelineDetailsRoute`,props:{record:{}},setup(e){let t=e,n=P(()=>t.record.start,{showSecond:!0});return(t,r)=>{let a=V,o=G;return e.record?(s(),b(`div`,Pe,[g(`div`,Fe,[x(a,{n:`green`,textContent:`Route Change`})]),g(`div`,Ie,[g(`span`,Le,y(e.record.from),1),r[0]||=g(`span`,{"i-carbon-arrow-right":``,op50:``},null,-1),g(`span`,null,y(e.record.to),1)]),g(`div`,Re,[e.record.end?(s(),h(o,{key:0,duration:e.record.end-e.record.start},null,8,[`duration`])):u(``,!0),r[1]||=g(`span`,{mx1:``,op50:``},`·`,-1),g(`div`,ze,y(i(n)),1)])])):u(``,!0)}}}),{__name:`TimelineDetailsRoute`}),Ve={key:0,"h-screen":``,"of-hidden":``},$={"h-screen":``,"w-full":``,flex:``,"flex-col":``},He={"h-10":``,flex:`~ gap-2 items-center justify-end`,p2:``,px3:``},Ue={"text-sm":``},We={"min-h-50":``,px3:``,py2:``},Ge=Object.assign(n({__name:`TimelineView`,setup(n){let r=T(),i=t(`table`),a=t(),c=_(()=>r.value?.metrics.clientTimeline());function d(){c.value&&(c.value.events=[])}function f(){i.value=i.value===`table`?`list`:`table`}return(t,n)=>{let r=l(`VTooltip`),m=M,_=oe,v=he,S=Ne,C=Be,w=R;return c.value?(s(),b(`div`,Ve,[g(`div`,$,[g(`div`,He,[x(r,{flex:``},{popper:p(()=>[g(`div`,Ue,y(c.value.options.enabled?`Recording...`:`Paused`),1)]),default:p(()=>[g(`div`,{"text-lg":``,class:o(c.value.options.enabled?`i-carbon-radio-button-checked text-primary animate-pulse`:`i-carbon-pause-outline op30`)},null,2)]),_:1}),c.value.options.enabled?(s(),h(m,{key:1,size:`small`,ml1:``,"text-sm":``,n:`orange`,icon:`i-carbon-stop`,onClick:n[1]||=e=>c.value.options.enabled=!1},{default:p(()=>[...n[6]||=[e(` Stop Tracking `,-1)]]),_:1})):(s(),h(m,{key:0,size:`small`,ml1:``,"text-sm":``,n:`primary`,icon:`i-carbon-play`,onClick:n[0]||=e=>c.value.options.enabled=!0},{default:p(()=>[...n[5]||=[e(` Start Tracking `,-1)]]),_:1})),n[7]||=g(`div`,{"flex-auto":``},null,-1),x(m,{icon:i.value===`table`?`i-carbon-roadmap`:`i-carbon-list`,class:`ml-2`,title:`Toggle View`,border:!1,onClick:f},null,8,[`icon`]),x(m,{icon:`i-carbon-trash-can`,"hover-text-red":``,class:`ml-2`,border:!1,onClick:d})]),i.value===`table`?(s(),h(_,{key:0,data:{...c.value},onSelect:n[2]||=e=>a.value=e.event},null,8,[`data`])):(s(),h(v,{key:1,data:{...c.value},onSelect:n[3]||=e=>a.value=e},null,8,[`data`]))]),x(w,{"model-value":!!a.value,"auto-close":``,transition:`bottom`,left:`#nuxt-devtools-side-nav`,onClose:n[4]||=e=>a.value=void 0},{default:p(()=>[g(`div`,We,[a.value?.type===`function`?(s(),h(S,{key:0,record:a.value},null,8,[`record`])):a.value?.type===`route`?(s(),h(C,{key:1,record:a.value},null,8,[`record`])):u(``,!0)])]),_:1},8,[`model-value`])])):u(``,!0)}}}),{__name:`TimelineView`}),Ke={},qe={class:`markdown-body`};function Je(t,n){return s(),b(`div`,qe,[...n[0]||=[g(`template`,null,[g(`div`,{class:`markdown-body`},[g(`h1`,null,`Timeline`),g(`blockquote`,{"text-orange":``,"bg-orange:10":``,py1:``},` This is an experimental feature `),g(`p`,null,`Timeline tracks your route navigations and functions calls in your Nuxt application. It can be used to debug performance issues and to understand how your application works.`),g(`h2`,null,`Function calls`),g(`p`,null,[e(`Nuxt DevTools tracks function calls by wrapping them in the build time. It works for functions referenced by auto-imports, or explicit imports through `),g(`code`,{"v-pre":``},`import {} from '#imports'`),e(`.`)]),g(`pre`,{class:`shiki shiki-themes vitesse-light vitesse-dark`,style:{"background-color":`#ffffff`,"--shiki-dark-bg":`#121212`,color:`#393a34`,"--shiki-dark":`#dbd7caee`},tabindex:`0`},[g(`code`,{"v-pre":``},[g(`span`,{class:`line`},[g(`span`,{style:{color:`#999999`,"--shiki-dark":`#666666`}},`<`),g(`span`,{style:{color:`#1E754F`,"--shiki-dark":`#4D9375`}},`script`),g(`span`,{style:{color:`#B07D48`,"--shiki-dark":`#BD976A`}},` setup`),g(`span`,{style:{color:`#999999`,"--shiki-dark":`#666666`}},`>`)]),e(`
...
`),g(`span`,{class:`line`},[g(`span`,{style:{color:`#999999`,"--shiki-dark":`#666666`}},`  }`)]),e(`
`),g(`span`,{class:`line`},[g(`span`,{style:{color:`#999999`,"--shiki-dark":`#666666`}},`})`)]),e(`
`),g(`span`,{class:`line`})])])])],-1)]])}var Ye=S(Ke,[[`render`,Je]]),Xe={flex:`~ col gap-2`,"w-150":``,p4:``,border:`t base`},Ze={op50:``},Qe={flex:`~ gap-3`,mt2:``,"justify-end":``},$e=n({__name:`timeline`,setup(t){let n=ee(),r=te(),a=D(),o=F();async function c(){try{let[e,t]=await C.enableTimeline(await E(),!0);if(!await a.start(e,t))return;await C.enableTimeline(await E(),!1)}catch{L({message:`Failed to enable timeline automatically. Check the terminal for more details.`,icon:`i-carbon-warning`,classes:`text-red`})}}return(t,l)=>{let u=Ge,f=H,m=j,_=z,v=q,y=M,S=O,C=Ye,w=B;return s(),b(d,null,[i(n)?.timeline?.enabled?(s(),h(u,{key:0})):(s(),b(d,{key:1},[x(m,null,{default:p(()=>[x(f,{icon:`i-carbon-roadmap`,name:`feature-timeline`,title:`Timeline`,description:`Timeline enables the inspection of when composable being executed and the route changes.`,actions:[{label:`Enable`}],onAction:c})]),_:1}),x(i(a),null,{default:p(({resolve:t,args:n})=>[x(S,{"model-value":!0,onClose:e=>t(!1)},{default:p(()=>[g(`div`,Xe,[l[5]||=g(`h2`,{"text-xl":``},[g(`span`,{capitalize:``},`Enable Timeline?`)],-1),g(`p`,Ze,[l[1]||=e(` Your `,-1),x(_,{role:`button`,n:`primary`,underline:``,onClick:l[0]||=e=>i(o)(i(r)?._nuxtConfigFile),textContent:`Nuxt config`}),l[2]||=e(` will be updated as: `,-1)]),x(v,{from:n[0],to:n[1],"max-h-80":``,"of-auto":``,py2:``,border:`~ base rounded`,lang:`ts`},null,8,[`from`,`to`]),l[6]||=g(`p`,null,[g(`span`,{op50:``},`Then Nuxt will `),g(`span`,{"text-orange":``},`restart automatically`),e(`. `)],-1),g(`div`,Qe,[x(y,{onClick:e=>t(!1)},{default:p(()=>[...l[3]||=[e(` Cancel `,-1)]]),_:1},8,[`onClick`]),x(y,{n:`solid primary`,capitalize:``,onClick:e=>t(!0)},{default:p(()=>[...l[4]||=[e(` Enable `,-1)]]),_:1},8,[`onClick`])])])]),_:2},1032,[`onClose`])]),_:1})],64)),x(w,null,{default:p(()=>[x(C)]),_:1})],64)}}});export{$e as default};