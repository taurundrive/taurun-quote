  ...
  async setup(_options, nuxt) {
    ...
    nuxt.hook("nitro:build:before", (nitro) => {
      ...
      if (!nitro.options.static) {
        ...
        const foldRouteRuleKey = (route) => caseSensitiveRouteRules ? route : route.toLowerCase();
        const routeRulesRouter = createRouter();
        for (const [route, rules] of Object.entries(nitro.options.routeRules)) {
          addRoute(routeRulesRouter, void 0, foldRouteRuleKey(route), rules);
        }
        for (const route of prerenderRoutes) {
          const rules = defu({}, ...findAllRoutes(routeRulesRouter, void 0, foldRouteRuleKey(route)).reverse());
          if (rules.prerender) {
