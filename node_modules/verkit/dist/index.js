...
function nextVersionAfter(version) {
	...
	return parse(prerelease?.length ? formatComparableVersion({
		major: version.major,
		minor: version.minor,
		patch: version.patch,
...
function samePrereleaseTuple(comparator, version) {
	...
	return candidate !== null && !!candidate.prerelease?.length && candidate.major === version.major && candidate.minor === version.minor && candidate.patch === version.patch;
}
